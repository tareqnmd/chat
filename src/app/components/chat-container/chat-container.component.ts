...
@Component({
  ...
  template: `
    <ng-container *ngIf="chatService.chatState$ | async as chatState">
      <div class="h-full flex flex-col bg-bg-app overflow-hidden">
        <div class="flex-1 overflow-y-auto w-full">
          <div class="min-h-full flex flex-col">
            <ng-container *ngIf="chatState.isInitialLoading && id && id !== 'new'; else notLoading">
            ...
            <ng-template #notLoading>
              <ng-container *ngIf="chatState.error === 'Chat not found'; else notError">
              ...
              <ng-template #notError>
                <ng-container *ngIf="chatState.messages.length === 0; else hasMessages">
                  <div class="flex-1 flex flex-col items-center justify-center p-6 w-full">
...
export class ChatContainerComponent implements OnInit, OnDestroy, AfterViewChecked {
  private latestChatState: any = { messages: [] };
  ...
  ngAfterViewChecked(): void {
    const currentMessageCount = this.latestChatState?.messages?.length ?? 0;
